      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-6 text-muted-foreground">
          <section>
            ...
            <p className="mb-3">We collect information to provide and improve our AI agent services:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Account Information:</strong> Email address and username when you create an account</li>
              <li><strong>Usage Data:</strong> Information about how you interact with our AI agents</li>
              <li><strong>Content Data:</strong> Prompts, files, and other content you submit for processing</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Providing and maintaining our AI agent services</li>
              <li>Processing your inputs and generating outputs</li>
              <li>Improving our agents and services</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-3">3. AI Processing & Data Storage</h2>
            <p>
              Content submitted to our AI agents is processed through secure third-party AI services. We temporarily store your content for processing and may retain anonymised data to improve our systems. Generated outputs are stored in your account.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We implement industry-standard security measures including encryption, secure authentication, and regular audits. However, no method of transmission over the internet is 100% secure.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We use cookies and similar technologies to maintain your session, remember preferences, and analyse service usage. You can control cookies through your browser settings.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              For privacy-related questions, contact us at <a href="mailto:n3o@n3os.com" className="text-primary hover:text-secondary transition-colors">n3o@n3os.com</a>.
            </p>
          </section>
